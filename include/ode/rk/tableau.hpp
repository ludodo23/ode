...
static constexpr auto make_a() {
    std::array<std::array<double, stages_extended>, stages_extended> A{};
    ...
    static constexpr std::array<std::array<double, stages_extended>, stages_extended> a = make_a();
